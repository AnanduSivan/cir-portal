...
urlpatterns = [
    ...
    url(r'^user/$', UserRegistrationView.as_view(), name='register_user'),
     ...
     url(r'^profile/edit/(?P<aums_id>\d+)/$', StudentListUpdateView.as_view(), name='student_profile_update'),
     ...
     url(r'^student/tests/technical/$', StudentTechnicalView.as_view(), name="technical_test"),
